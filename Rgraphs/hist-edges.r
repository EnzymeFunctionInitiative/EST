...
#barplot(plot_data, main = paste("Number of Edges at Alignment Score", jobnum), ylab = "Number of Edges", xlab = "Alignment Score", col = "red", border = "blue", cex.main = 2.5, cex.axis = 1.8, cex.lab = 1.3)
