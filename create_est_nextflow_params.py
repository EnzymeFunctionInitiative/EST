...
def add_parameter_args(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--fasta-db", required=True, type=str, help="FASTA file to create SSN from")
...
def render_params_template(output_dir, duckdb_memory_limit, duckdb_threads, fasta_shards, blast_matches, job_id, efi_config, fasta_db, import_mode, exclude_fragments, families, family_id_format):
    params = {
