...
def add_args(parser: argparse.ArgumentParser):
    ...
    """
    parser.add_argument("--source-dir", type=str, required=True, help="Path to the root ENA dataset directory")
...
def check_args(args: argparse.Namespace) -> argparse.Namespace:
    ...
    if not os.path.exists(args.source_dir):
        print(f"ENA source directory '{args.source_dir}' does not exist")
        fail = True
...
def render_params(source_dir, output_dir, efi_config, efi_db):
    params = {
