...
NXF_SCRIPT = "pipelines/neighborhoodconnectivity/neighborhoodconnectivity.nf"

def add_args(parser: argparse.ArgumentParser):
    """
    Add arguments for Neighborhood Connectivity pipeline to ``parser``
    """
...
def render_params(ssn_input, efi_config, efi_db, output_dir, **kwargs: dict):
    params = {
