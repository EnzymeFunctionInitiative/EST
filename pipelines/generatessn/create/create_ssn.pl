...
# If the user doesn't provide a --max-edges argument, then use this default
...
my $title = $opts->{title} // "Sequence Similarity Network";
...
sub validateAndProcessOptions {
    ...
    $optParser->addOption("repnode-cdhit=s", 0, "path to file containing CD-HIT clusters; including this will output a repnode network", OPT_FILE);
