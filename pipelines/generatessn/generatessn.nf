...
workflow {
    ...
    // Get sunburst data for sequence IDs, after filtering; we don't use the est.nf output
    // because of applying filtering
    get_sunburst_data(final_ids.accession_table, final_ids.sequence_metadata)
