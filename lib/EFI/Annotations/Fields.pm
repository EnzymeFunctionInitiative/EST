...
use constant FIELD_IS_FRAGMENT => "is_fragment";
...
use constant FIELD_NB_CONN => "connectivity";
use constant FIELD_NB_CONN_COLOR => "nb_connectivity_color";
