...
nextflow -log $OUTPUT_DIR/est_nextflow.log -C $NXF_EST_CONFIG_FILE run pipelines/est/est.nf -params-file $OUTPUT_DIR/params.yml -w $OUTPUT_DIR/est_work -with-dag $OUTPUT_DIR/sequence_blast_nf.html
...
nextflow -log $OUTPUT_DIR/generatessn_nextflow.log -C $NXF_SSN_CONFIG_FILE run pipelines/generatessn/generatessn.nf -params-file $OUTPUT_DIR/ssn/params.yml -w $OUTPUT_DIR/generatessn_work -with-dag $OUTPUT_DIR/generatessn_nf.html
