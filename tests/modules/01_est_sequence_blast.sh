...
nextflow -log $OUTPUT_DIR/est_nextflow.log -C $NXF_EST_CONFIG_FILE run pipelines/est/est.nf -params-file $OUTPUT_DIR/params.yml -w $OUTPUT_DIR/est_work -with-dag docs/source/pipelines/est/est_family_blast_accession_nf.mmd
...
nextflow -log $OUTPUT_DIR/generatessn_nextflow.log -C $NXF_SSN_CONFIG_FILE run pipelines/generatessn/generatessn.nf -params-file $OUTPUT_DIR/ssn/params.yml -w $OUTPUT_DIR/generatessn_work -with-dag docs/source/pipelines/generatessn/generatessn_nf.mmd
