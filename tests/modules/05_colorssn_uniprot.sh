...
nextflow -log $OUTPUT_DIR/colorssn_nextflow.log -C $NXF_COLORSSN_CONFIG_FILE run pipelines/colorssn/colorssn.nf -params-file $OUTPUT_DIR/params.yml -w $OUTPUT_DIR/colorssn_work -with-dag $OUTPUT_DIR/colorssn_nf.html
