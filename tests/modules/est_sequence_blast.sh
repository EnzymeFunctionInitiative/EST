...
./bin/create_est_nextflow_params.py blast --output-dir $OUTPUT_DIR --efi-config smalldata/efi.config --fasta-db smalldata/blastdb/combined.fasta --efi-db smalldata/efi_db.sqlite --blast-query-file smalldata/blast_query.fa
