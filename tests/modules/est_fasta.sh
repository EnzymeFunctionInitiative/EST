...
python bin/create_est_nextflow_params.py fasta --output-dir $OUTPUT_DIR --efi-config smalldata/efi.config --fasta-db smalldata/blastdb/combined.fasta --efi-db smalldata/efi_db.sqlite --fasta-file smalldata/test.fasta
