...
python create_est_nextflow_params.py fasta --output-dir $OUTPUT_DIR --efi-config smalldata/efi.config --fasta-db smalldata/databases/blastdb/combined.fasta --efi-db smalldata/databases/efi_db.sqlite --fasta-file smalldata/test.fasta
