...
./bin/create_colorssn_nextflow_params.py --final-output-dir $OUTPUT_DIR --ssn-input "$TEST_RESULTS_DIR/test_results_accession/ssn/full_ssn.xgmml" --efi-config smalldata/efi.config --efi-db smalldata/efi_db.sqlite
