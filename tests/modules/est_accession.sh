...
python create_est_nextflow_params.py accessions --output-dir $OUTPUT_DIR --efi-config smalldata/efi.config --fasta-db smalldata/blastdb/combined.fasta --efi-db smalldata/efi_db.sqlite --accessions-file smalldata/pf07476.txt
...
nextflow -C $NXF_CONFIG_FILE run ssn.nf -params-file $OUTPUT_DIR/ssn/params.yml